...
int main(int argc, char *argv[]){
  ...
  /*
  ofstream fs("./output_dir/random_20161223_10-15/output_excel_random_20161223_10-15"
      , ios::app);
  fs << n << "," << m << "," << beforeCount << "," << afterSifting << "," << static_cast<double>(time)/(CLOCKS_PER_SEC) << "," << circular_local_round_num <<  endl;
  fs.close();
  */
  return 0;
}
